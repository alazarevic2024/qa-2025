...
class TestJelo(TestCase):
    @classmethod
    def setUpClass(cls):
        print("POKRETANJE PRE SVIH TESTOVA - SETUPCLASS")
    
    @classmethod
    def tearDownClass(cls):
        print("POKRETANJE NAKON SVIH TESTOVA - TEARDOWNCLASS")
    ...
    def test_promeni_cenu(self):
        print("TEST 1")
        self.jelo.promeni_cenu(900) # when
        self.assertEqual(self.jelo.cena, 900) # then
    
    def test_dodaj_porez(self):
        print("TEST 2")
        self.jelo.dodaj_porez(20)
        self.assertEqual(self.jelo.cena, 960)
    
    def test_porez_nula(self):
        print("TEST 3")
        self.jelo.dodaj_porez(0)
        self.assertEqual(self.jelo.cena, 800)
