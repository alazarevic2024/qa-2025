...
def korisnik_salje_zahtev(korisnik_id):
    print(f"Korisnik: {korisnik_id} salje zahtev ka serveru...")

    vreme_cekanja = random.randint(1, 4)
    time.sleep(vreme_cekanja)

    print(f"Korisnik {korisnik_id} je dobio podatke nakon {vreme_cekanja}s.")
